...
//        if withLoader {
//            ViewData.shared.isLoading = true
//        }
...
//MARK: - Error Builder
    @MainActor private static func errorBuilder<T: EndPoint, Model: Codable>(endPoint: T, error: Error, model: Model.Type, withLoader: Bool, errorHandler: Bool) async -> BaseResponse<Model> {
        if withLoader {
